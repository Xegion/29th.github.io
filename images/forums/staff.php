    ...
    <?php
            ...
            foreach ($ranks as $rank) {
                ...
                foreach ($st->fetchAll() as $row) {
                    ...
                    if(!$time){
                        $time = 0;
                    }					if ($rank["name"] == "superadmin") {						$rank["name"] = "Root";					}					if ($rank["name"] == "developer") {						$rank["name"] = "Developer";					}					if ($rank["name"] == "sudo") {						$rank["name"] = "Sudo Root";					}					if ($rank["name"] == "headmod") {						$rank["name"] = "Head Mod";					}					if ($rank["name"] == "seniormod") {						$rank["name"] = "Senior Mod";					}					if ($rank["name"] == "moderator") {						$rank["name"] = "Moderator";					}					if ($rank["name"] == "trialmod") {						$rank["name"] = "Trial Mod";					}					
                ?>
                    <tr class="trow1">
